SUMMARY = "Trusted Firmware-A for Nuvoton MA35D0K5"
...
# Configure ma35d05k make settings
...
do_compile:prepend() {
    if echo ${TFA_DTB} | grep -q "custom"; then
        cp ${UNPACKDIR}/${TFA_DDR_HEADER} ${S}/plat/nuvoton/${PLATFORM}/include/custom_ddr.h
    fi
}
