# meta-evb-ma35d05k: OpenBMC BSP Layer for Nuvoton MA35D05K

OpenBMC Board Support Package for the **Nuvoton NuMaker-IoT-MA35D05KI1** evaluation board.
...
| Item | Detail |
|------|--------|
| SoC | MA35D05K (dual Cortex-A35 @ 650 MHz) |
| RAM | 256 MB DDR3L |
...
# First-time setup
TEMPLATECONF=meta-numaker/meta-evb-ma35d05k/conf/templates/default \
  source oe-init-build-env build-ma35d05k

# Build (generates pack.bin automatically)
bitbake nuwriter-ma35d05k-pack
```

Output: `tmp/deploy/images/numaker-iot-ma35d05ki1/pack/pack.bin`

> On subsequent builds, just `source oe-init-build-env build-ma35d05k` to re-enter.
...
| BL2 DTB | `bl2-ma35d05k.dtb` | `0x0C0000` |
| BL2 | `bl2-ma35d05k.bin` | `0x0E0000` |
