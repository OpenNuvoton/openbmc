SUMMARY = "Generate NuWriter pack.bin for MA35D0K5 SPI NAND programming"
...
do_compile[depends] += " \
    tf-a-ma35d05k:do_deploy \
    u-boot-ma35d05k:do_deploy \
    linux-ma35d05k:do_deploy \
...
do_compile() {
    ...
    ${DEPLOY_DIR_IMAGE_MA35D0}/fiptool create \
        --soc-fw ${DEPLOY_DIR_IMAGE_MA35D0}/bl31-ma35d1.bin \
