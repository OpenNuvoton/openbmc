...
# --- Configuration Area ---
BMC_IP="numaker-iot-ma35d0.local"  # mDNS hostname (avahi)
USER="root"
PASS="0penBmc"
REPORT_FILE="$(dirname "$0")/numaker-iot-ma35d0.md"
# -------------------------
...
cat > "$REPORT_FILE" << EOF
# MA35D0 OpenBMC Functions Integration Test Report

**Date**: $(date '+%Y-%m-%d %H:%M:%S')
**BMC IP**: ${BMC_IP}
**Platform**: NuMaker-IoT-MA35D0
...
echo -e "${BLUE}====================================================${NC}"
echo -e "      MA35D0 OpenBMC Functions Integration Test       "
echo -e "${BLUE}====================================================${NC}"
